...
export default function DashboardLayout({
  ...
  // Estado para a barra de pesquisa global
    ...
    <>
      ...
      <div className="hidden md:flex h-screen w-full bg-neutral-50 dark:bg-[#0E0E0E] transition-colors duration-200">
        ...
        <main className="flex-1 flex flex-col overflow-hidden relative">
          {/* CABEÇALHO ALINHADO: Container limitador de 1600px adicionado */}
                ...
                <div className="flex items-center gap-3 w-full max-w-2xl">
                  <div className="relative flex-1">
                    ...
                    <input 
                      ...
                      className="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-[#1A1A1A] border border-neutral-200 dark:border-neutral-800 rounded-xl text-sm font-medium text-black dark:text-white placeholder:text-neutral-500 focus:outline-none focus:border-[#5C67FF] transition-colors shadow-sm"
                    />
                  </div>
                  <Link 
                    href="/receitas?new=true" 
                    className="flex items-center justify-center gap-2 px-4 py-2.5 bg-[#5C67FF] text-white rounded-xl text-sm font-semibold hover:bg-[#4A54D4] transition-colors shadow-sm whitespace-nowrap"
                  >
                    <Plus size={16} /> Receita
                  </Link>
                  <Link 
                    href="/lancamentos?new=true" 
                    className="flex items-center justify-center gap-2 px-4 py-2.5 bg-[#5C67FF] text-white rounded-xl text-sm font-semibold hover:bg-[#4A54D4] transition-colors shadow-sm whitespace-nowrap"
                  >
              ...
              <div className="flex items-center gap-4 shrink-0 ml-4">
                {mounted && (
                  <button
                    ...
                    className="p-2.5 rounded-full bg-white dark:bg-[#151515] border border-neutral-200 dark:border-neutral-800/80 hover:bg-neutral-100 dark:hover:bg-neutral-800 text-black dark:text-white transition-colors shadow-sm"
